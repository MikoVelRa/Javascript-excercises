...
const ordenarLista = otraLista => {
  ...
  return `Número mas alto: ${otraLista[otraLista.length - 1]}, mas corto: ${
    otraLista[0]
  }`;
};

//Forma IZY
const ordenandoConMath = list =>`Valor mas pequeño: ${Math.min(...list)}, valor mas grande: ${Math.max(...list)}`;
...
console.log(ordenandoConMath([0,1,2,3,-8,12.34]));
